...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Bold Ocean Blue Primary Palette
        primary: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
      ...
      spacing: {
        ...
        '144': '36rem',
        '160': '40rem',
        // Standardized layout spacing tokens
        'layout-xs': '0.25rem',   // 4px
        'layout-sm': '0.5rem',    // 8px
        'layout-md': '0.75rem',   // 12px
        'layout-lg': '1rem',      // 16px
        'layout-xl': '1.5rem',    // 24px
        'layout-2xl': '2rem',     // 32px
        'layout-3xl': '3rem',     // 48px
      },
